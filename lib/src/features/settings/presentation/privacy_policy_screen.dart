        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              content:
                  'We use third-party services to provide stock market data. These third parties may collect information used to identify your device, such as your IP address, to facilitate API requests.\n\nPolygon.io: We use Polygon.io to fetch real-time and historical stock market data, company details, financials, and news. By using our App, you acknowledge that your device makes direct requests to the Polygon.io API. Please refer to Polygon.io’s Privacy Policy for more information on how they handle data.',
            ),
            _buildSection(
              context,
